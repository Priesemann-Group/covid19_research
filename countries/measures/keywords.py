# Sort alphabetically
avoid_going_out_if_risk_group = "if belonging to a risk group only go out if necessary"
...
forbid_assemblies_500 = "forbid assemblies > 500 people"
forbid_assemblies_all = "forbid all assemblies (<=10)"
keep_distance = "minimum distance 1.5m (or 2m or 1m)"
lockdown = "lockdown: not allowed to enter public spaces, remain home (if not necessary)"
only_essential_travel = "advice: only essential travel"
social_distancing = "avoid social contact"
...
demonstration_start = "Start of anti lockdown/corona demonstartions"
