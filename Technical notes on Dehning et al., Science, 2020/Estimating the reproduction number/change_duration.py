...
def plot_daily_cases_and_r_smoothing(keys=None, linestyles=None):
    ...
    fig_r.savefig("figures/r_comparison.pdf", **save_kwargs)
    fig_delay.savefig("figures/r_left_right.pdf", **save_kwargs)
...
def plot_rki_convention(key):
    ...
    fig.savefig("figures/rki_convention.pdf", **save_kwargs)
